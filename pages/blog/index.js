        ...
        <div>
            ...
            <div className="row container mt-3 ms-4 mb-5">
                ...
                <div className="col-12 col-sm-12 col-md-6 col-lg-4">
                    ...
                    <p className="text-center">সৈয়দ ওয়ালীউল্লাহ্‌ (১৫ আগস্ট ১৯২২ - ১০ অক্টোবর ১৯৭১) ছিলেন আধুনিক বাংলা সাহিত্যের একজন কথাশিল্পী। কল্লোল যুগের ধারাবাহিকতায় তাঁর আবির্ভাব হলেও তিনি ইউরোপীয় আধুনিকতায় পরিশ্রুত নতুন কথাসাহিত্য বলয়ের শিলান্যাস করেন। জগদীশ গুপ্ত, মানিক বন্দ্যোপাধ্যায় প্রমুখের উত্তরসূরি এই কথাসাহিত্যিক অগ্রজদের কাছ থেকে পাঠ গ্রহণ করলেও বিষয়, কাঠামো ...<Link href='/blog/rabindranath' ><a className='ms-3 text-decoration-none '>আরো পড়ুন</a></Link></p>
                </div>
            </div>
            <Footer></Footer>
        </div>
